...
let
  sources = {
    ...
    "fraction.js-4.3.3" = {
      ...
      version = "4.3.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/fraction.js/-/fraction.js-4.3.3.tgz";
        sha512 = "tkkgxPcxJO0waFMe9i3zIES/tbhgOxXT/20ESNQkUvWASktF8Mxnt0vt147ZA+MNGme+w3mmPD0m61ySNmpTHw==";
      };
    };
    "fs-extra-11.1.1" = {
      name = "fs-extra";
