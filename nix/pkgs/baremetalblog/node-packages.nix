...
let
  sources = {
    ...
    "caniuse-lite-1.0.30001524" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/caniuse-lite/-/caniuse-lite-1.0.30001524.tgz";
    ...
    "fraction.js-4.3.2" = {
      ...
      version = "4.3.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/fraction.js/-/fraction.js-4.3.2.tgz";
        sha512 = "9VLF466MqX1OUP7/d9r7/Vsvu6Hpp+taXBLmiR5x6mEYfT0BDkGVBt5TyA1aDu1WzIE1sF8F66evOFaz7iAEGQ==";
      };
    };
    "fs-extra-11.1.1" = {
      name = "fs-extra";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."caniuse-lite-1.0.30001524"
      (sources."chalk-4.1.2" // {
        dependencies = [
