...
let
  sources = {
    ...
    "@types/node-20.11.14" = {
      ...
      version = "20.11.14";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-20.11.14.tgz";
        sha512 = "w3yWCcwULefjP9DmDDsgUskrMoOy5Z8MiwKHr1FvqGPtx7CvJzQvxD7eKpxNtklQxLruxSXWddyeRtyud0RcXQ==";
      };
    };
    "acorn-8.11.3" = {
      name = "acorn";
