...
let
  sources = {
    ...
    "electron-to-chromium-1.4.701" = {
      ...
      version = "1.4.701";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.701.tgz";
        sha512 = "K3WPQ36bUOtXg/1+69bFlFOvdSm0/0bGqmsfPDLRXLanoKXdA+pIWuf/VbA9b+2CwBFuONgl4NEz4OEm+OJOKA==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.701"
