...
let
  sources = {
    ...
    "fraction.js-4.3.1" = {
      ...
      version = "4.3.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/fraction.js/-/fraction.js-4.3.1.tgz";
        sha512 = "nx0cki48JBA6ThPeUpeKCNpdhEl/9bRS+dAEYnRUod+Z1jhFfC3K/mBLorZZntqHM+GTH3/dkkpfoT3QITYe7g==";
      };
    };
    "fs-extra-11.1.1" = {
      name = "fs-extra";
