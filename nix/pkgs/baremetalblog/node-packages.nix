...
let
  sources = {
    ...
    "@swc/core-1.3.104" = {
      ...
      version = "1.3.104";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/core/-/core-1.3.104.tgz";
        sha512 = "9LWH/qzR/Pmyco+XwPiPfz59T1sryI7o5dmqb593MfCkaX5Fzl9KhwQTI47i21/bXYuCdfa9ySZuVkzXMirYxA==";
      };
    };
    "@swc/counter-0.1.2" = {
    ...
    "@swc/wasm-1.3.104" = {
      ...
      version = "1.3.104";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/wasm/-/wasm-1.3.104.tgz";
        sha512 = "NtJscObQuMsYIeRV5YhUPI0SCWeMgPBHekbEJUtogxx6UYGiyVYeaX2k2ez0k3fFmY4/644tYVKOAlLs59g9Ww==";
      };
    };
    ...
    "electron-to-chromium-1.4.637" = {
      ...
      version = "1.4.637";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.637.tgz";
        sha512 = "G7j3UCOukFtxVO1vWrPQUoDk3kL70mtvjc/DC/k2o7lE0wAdq+Vwp1ipagOow+BH0uVztFysLWbkM/RTIrbK3w==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.637"
