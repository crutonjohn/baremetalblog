...
let
  sources = {
    ...
    "caniuse-lite-1.0.30001589" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/caniuse-lite/-/caniuse-lite-1.0.30001589.tgz";
    ...
    "electron-to-chromium-1.4.679" = {
      ...
      version = "1.4.679";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.679.tgz";
        sha512 = "NhQMsz5k0d6m9z3qAxnsOR/ebal4NAGsrNVRwcDo4Kc/zQ7KdsTKZUxZoygHcVRb0QDW3waEDIcE3isZ79RP6g==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."caniuse-lite-1.0.30001589"
      (sources."chalk-4.1.2" // {
        dependencies = [
      ...
      sources."electron-to-chromium-1.4.679"
