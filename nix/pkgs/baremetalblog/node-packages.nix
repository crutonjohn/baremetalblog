...
let
  sources = {
    ...
    "@swc/core-1.4.4" = {
      ...
      version = "1.4.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/core/-/core-1.4.4.tgz";
        sha512 = "P88AHGWM8xPY3Tjj5360V6vqKCS5UfsyffPJVnr7BKSr45rlG4/pjEGGmFYQjg6ztgPyrGLYz1jSyzajTqTVIA==";
      };
    };
    "@swc/counter-0.1.3" = {
    ...
    "@swc/wasm-1.4.4" = {
      ...
      version = "1.4.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/wasm/-/wasm-1.4.4.tgz";
        sha512 = "dAtNJkiLNpSFfJ6/nlk3PeEVwEt4nrxyV3rdc7eA9oJUF3epyldpDD+3PgsRhFQzQeos+KUG4Cxv/yHUTesx+Q==";
      };
    };
