...
let
  sources = {
    ...
    "caniuse-lite-1.0.30001543" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/caniuse-lite/-/caniuse-lite-1.0.30001543.tgz";
        sha512 = "qxdO8KPWPQ+Zk6bvNpPeQIOH47qZSYdFZd6dXQzb2KzhnSXju4Kd7H1PkSJx6NICSMgo/IhRZRhhfPTHYpJUCA==";
      };
    };
    "chalk-4.1.2" = {
      name = "chalk";
    ...
    "electron-to-chromium-1.4.541" = {
      name = "electron-to-chromium";
      packageName = "electron-to-chromium";
      version = "1.4.541";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.541.tgz";
        sha512 = "do9EfdtgtowzRNdnUhFtc0wMjazMHiXBNP/848cNa22dmmRSVE2JuBKfcjt0tg2+FN90OIE4E6MbcQ2bzDRawg==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."caniuse-lite-1.0.30001543"
      (sources."chalk-4.1.2" // {
        dependencies = [
      ...
      sources."dlv-1.1.3"
      sources."electron-to-chromium-1.4.541"
