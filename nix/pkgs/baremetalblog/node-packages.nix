...
let
  sources = {
    ...
    "@swc/wasm-1.3.105" = {
      ...
      version = "1.3.105";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/wasm/-/wasm-1.3.105.tgz";
        sha512 = "I65R/dXLbSqPJ+9FZ4/aWCMPhHsrROE/8E9ASTlDyBNLEBOmCKO2x+TZCg9yGhH9HNVPucx+k0dNlyzXlSWTDA==";
      };
    };
    ...
    "electron-to-chromium-1.4.645" = {
      ...
      version = "1.4.645";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.645.tgz";
        sha512 = "EeS1oQDCmnYsRDRy2zTeC336a/4LZ6WKqvSaM1jLocEk5ZuyszkQtCpsqvuvaIXGOUjwtvF6LTcS8WueibXvSw==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.645"
