...
let
  sources = {
    ...
    "@swc/core-1.4.5" = {
      ...
      version = "1.4.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/core/-/core-1.4.5.tgz";
        sha512 = "4/JGkG4b1Z/QwCGgx+Ub46MlzrsZvBk5JSkxm9PcZ4bSX81c+4Y94Xm3iLp5Ka8NxzS5rD4mJSpcYuN3Tw0ceg==";
      };
    };
    "@swc/counter-0.1.3" = {
    ...
    "@swc/wasm-1.4.5" = {
      ...
      version = "1.4.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/wasm/-/wasm-1.4.5.tgz";
        sha512 = "WN0S19Dg71z/EJNMPEISEa69QojDXLmcy12kjtv7xRI9QgAUio9XcuY8aKxtaibwldrWridtiXBAChaz01oR2g==";
      };
    };
    ...
    "caniuse-lite-1.0.30001596" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/caniuse-lite/-/caniuse-lite-1.0.30001596.tgz";
        sha512 = "zpkZ+kEr6We7w63ORkoJ2pOfBwBkY/bJrG/UZ90qNb45Isblu8wzDgevEOrRL1r9dWayHjYiiyCMEXPn4DweGQ==";
      };
    };
    "chalk-4.1.2" = {
      name = "chalk";
    ...
    "electron-to-chromium-1.4.696" = {
      name = "electron-to-chromium";
      packageName = "electron-to-chromium";
      version = "1.4.696";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.696.tgz";
        sha512 = "SOr0bHP52OvYg2chCsz/0+FUSMGFm8L8HKwPpx3cbwRY24EOemVJtbgTm+IFO8LzhcnPy+hXmTq7ZcZ8uUuaYg==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."caniuse-lite-1.0.30001596"
      (sources."chalk-4.1.2" // {
        dependencies = [
      ...
      sources."electron-to-chromium-1.4.696"
