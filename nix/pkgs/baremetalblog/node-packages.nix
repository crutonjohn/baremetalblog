...
let
  sources = {
    ...
    "@swc/wasm-1.3.98" = {
      ...
      version = "1.3.98";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/wasm/-/wasm-1.3.98.tgz";
        sha512 = "+wKWKUHLl0e30i5usDvJS3MfV2IjLEZQKDjrWZ/JIkzLgmCvygw6aGku0sxBwCynXBuSl36rf2EfmaPn6+yQ6g==";
      };
    };
