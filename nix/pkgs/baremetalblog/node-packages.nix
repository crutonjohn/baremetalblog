...
let
  sources = {
    ...
    "@types/node-20.11.2" = {
      ...
      version = "20.11.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-20.11.2.tgz";
        sha512 = "cZShBaVa+UO1LjWWBPmWRR4+/eY/JR/UIEcDlVsw3okjWEu+rB7/mH6X3B/L+qJVHDLjk9QW/y2upp9wp1yDXA==";
      };
    };
    "acorn-8.11.3" = {
      name = "acorn";
