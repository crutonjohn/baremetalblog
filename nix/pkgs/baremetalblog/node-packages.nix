...
let
  sources = {
    ...
    "@swc/core-1.4.6" = {
      ...
      version = "1.4.6";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/core/-/core-1.4.6.tgz";
        sha512 = "A7iK9+1qzTCIuc3IYcS8gPHCm9bZVKUJrfNnwveZYyo6OFp3jLno4WOM2yBy5uqedgYATEiWgBYHKq37KrU6IA==";
      };
    };
    "@swc/counter-0.1.3" = {
    ...
    "@swc/wasm-1.4.6" = {
      ...
      version = "1.4.6";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/wasm/-/wasm-1.4.6.tgz";
        sha512 = "YY5IrWIK8Vy6qcUvFdqiILlYE+sn0bKynqHbjSvyCRYAX8NLU770LQhsjHKtKv0PuNAlLUMWzCd8pMM9SiTQrQ==";
      };
    };
    ...
    "electron-to-chromium-1.4.699" = {
      ...
      version = "1.4.699";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.699.tgz";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.699"
