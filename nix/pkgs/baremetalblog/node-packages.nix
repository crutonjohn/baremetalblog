...
let
  sources = {
    ...
    "@types/node-20.11.9" = {
      ...
      version = "20.11.9";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-20.11.9.tgz";
        sha512 = "CQXNuMoS/VcoAMISe5pm4JnEd1Br5jildbQEToEMQvutmv+EaQr90ry9raiudgpyDuqFiV9e4rnjSfLNq12M5w==";
      };
    };
    "acorn-8.11.3" = {
      name = "acorn";
