...
let
  sources = {
    ...
    "@swc/wasm-1.3.81" = {
      ...
      version = "1.3.81";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/wasm/-/wasm-1.3.81.tgz";
        sha512 = "C/3eQ0bBY/zG3K+zrpnFPksmw1cuPEmItovywz2SNH65T/KuSWY7kxshy9l1VXj3e6jgsEG8Yvu0kyQ9MJKUBg==";
      };
    };
