...
let
  sources = {
    ...
    "@types/node-20.11.12" = {
      ...
      version = "20.11.12";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-20.11.12.tgz";
        sha512 = "N/Az9BkJ6IWCJ3GeKea/vMQLfV37ci1fApx2x5UQvfa0N5OTjR/c17hEkt6Q0LSF6XSF7hcgrd/DOobibskPNw==";
      };
    };
    "acorn-8.11.3" = {
      name = "acorn";
    ...
    "electron-to-chromium-1.4.651" = {
      ...
      version = "1.4.651";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.651.tgz";
        sha512 = "jjks7Xx+4I7dslwsbaFocSwqBbGHQmuXBJUK9QBZTIrzPq3pzn6Uf2szFSP728FtLYE3ldiccmlkOM/zhGKCpA==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.651"
