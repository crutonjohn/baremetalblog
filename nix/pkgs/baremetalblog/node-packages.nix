...
let
  sources = {
    ...
    "fraction.js-4.3.0" = {
      ...
      version = "4.3.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/fraction.js/-/fraction.js-4.3.0.tgz";
        sha512 = "btalnXjFelOv2cy86KzHWhUuMb622/AD8ce/MCH9C36xe7QRXjJZA+19fP+G5LT0fdRcbOHErMI3SPM11ZaVDg==";
      };
    };
    "fs-extra-11.1.1" = {
      name = "fs-extra";
