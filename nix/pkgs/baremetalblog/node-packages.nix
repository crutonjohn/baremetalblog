...
let
  sources = {
    ...
    "caniuse-lite-1.0.30001526" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/caniuse-lite/-/caniuse-lite-1.0.30001526.tgz";
        sha512 = "0UAJj+6ga1IzMcKB6PbNPEXuIpYffmiZL6Innn03+3fX1lm8P70cfAHzD7jekkYj+lMs5vB1iWCRXf3fS1GW8A==";
      };
    };
    "chalk-4.1.2" = {
      name = "chalk";
    ...
    "electron-to-chromium-1.4.508" = {
      ...
      version = "1.4.508";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.508.tgz";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."caniuse-lite-1.0.30001526"
      (sources."chalk-4.1.2" // {
        dependencies = [
      ...
      sources."dlv-1.1.3"
      sources."electron-to-chromium-1.4.508"
