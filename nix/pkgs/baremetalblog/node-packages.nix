...
let
  sources = {
    ...
    "@swc/wasm-1.3.103" = {
      ...
      version = "1.3.103";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/wasm/-/wasm-1.3.103.tgz";
        sha512 = "CO1e6PBZ4UBsmra/CJ/pK0nfJ3l+m4wOX6Eqm7pfeezmsmxGzrn80gc9f7hozSs9Ib0tugqp5RicoIJdKjm5vg==";
      };
    };
    ...
    "electron-to-chromium-1.4.632" = {
      ...
      version = "1.4.632";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.632.tgz";
        sha512 = "JGmudTwg7yxMYvR/gWbalqqQiyu7WTFv2Xu3vw4cJHXPFxNgAk0oy8UHaer8nLF4lZJa+rNoj6GsrKIVJTV6Tw==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.632"
