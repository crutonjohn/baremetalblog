...
let
  sources = {
    ...
    "@swc/wasm-1.3.106" = {
      ...
      version = "1.3.106";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/wasm/-/wasm-1.3.106.tgz";
        sha512 = "CPKr5n2D9kCqZs6MXNoUm0ygsLX6xul18X2jr9fTspVNxzyt0d2Sac/8LIV6B/3gL4B6/oRMf4eoZJTmAvTwpA==";
      };
    };
