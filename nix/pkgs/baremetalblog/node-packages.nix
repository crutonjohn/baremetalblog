...
let
  sources = {
    ...
    "electron-to-chromium-1.4.555" = {
      name = "electron-to-chromium";
      packageName = "electron-to-chromium";
      version = "1.4.555";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.555.tgz";
        sha512 = "k1wGC7UXDTyCWcONkEMRG/w6Jvrxi+SVEU+IeqUKUKjv2lGJ1b+jf1mqrloyxVTG5WYYjNQ+F6+Cb1fGrLvNcA==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."dlv-1.1.3"
      sources."electron-to-chromium-1.4.555"
