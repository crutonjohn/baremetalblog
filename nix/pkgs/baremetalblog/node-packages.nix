...
let
  sources = {
    ...
    "@types/node-20.11.21" = {
      ...
      version = "20.11.21";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-20.11.21.tgz";
        sha512 = "/ySDLGscFPNasfqStUuWWPfL78jompfIoVzLJPVVAHBh6rpG68+pI2Gk+fNLeI8/f1yPYL4s46EleVIc20F1Ow==";
      };
    };
    "acorn-8.11.3" = {
      name = "acorn";
    ...
    "electron-to-chromium-1.4.683" = {
      ...
      version = "1.4.683";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.683.tgz";
        sha512 = "FmopjiJjkUzqa5F5Sv+wxd8KimtCxyLFOFgRPwEeMLVmP+vHH/GjNGCuIYrCIchbMSiOe+nG/OPBbR/XoExBNA==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.683"
