...
let
  sources = {
    ...
    "@swc/wasm-1.4.7" = {
      ...
      version = "1.4.7";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/wasm/-/wasm-1.4.7.tgz";
        sha512 = "9Nu1OWXjhvH18S/g9FfzL+J+5QZQ21nzanATirSYu0g3xPqZ2OGQvsitdw9dodZP43oxfnK08+Z3rWLbK69XhA==";
      };
    };
    ...
    "electron-to-chromium-1.4.704" = {
      ...
      version = "1.4.704";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.704.tgz";
        sha512 = "OK01+86Qvby1V6cTiowVbhp25aX4DLZnwar+NocAOXdzKAByd+jq5156bmo4kHwevWMknznW18Y/Svfk2dU91A==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.704"
