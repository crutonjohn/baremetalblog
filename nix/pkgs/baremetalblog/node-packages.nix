...
let
  sources = {
    ...
    "@swc/core-1.4.2" = {
      ...
      version = "1.4.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/core/-/core-1.4.2.tgz";
    ...
    "@swc/wasm-1.4.2" = {
      ...
      version = "1.4.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/wasm/-/wasm-1.4.2.tgz";
        sha512 = "RUaujFapRSVcQAhxp1AV4+TUKK6tIYW7++rvYmfxwUjypjPE9zzJCgSylbhlhFHf6rVcx0h/+IbnrbyENITq8g==";
      };
    };
    ...
    "@types/node-20.11.22" = {
      ...
      version = "20.11.22";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-20.11.22.tgz";
        sha512 = "/G+IxWxma6V3E+pqK1tSl2Fo1kl41pK1yeCyDsgkF9WlVAme4j5ISYM2zR11bgLFJGLN5sVK40T4RJNuiZbEjA==";
      };
    };
    "acorn-8.11.3" = {
      name = "acorn";
    ...
    "electron-to-chromium-1.4.687" = {
      ...
      version = "1.4.687";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.687.tgz";
        sha512 = "Ic85cOuXSP6h7KM0AIJ2hpJ98Bo4hyTUjc4yjMbkvD+8yTxEhfK9+8exT2KKYsSjnCn2tGsKVSZwE7ZgTORQCw==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.687"
